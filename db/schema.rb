...
ActiveRecord::Schema[7.0].define(version: 2022_05_21_090017) do
  ...
  create_table "reply_likes", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "reply_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "replys", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "contents"
    t.integer "user_id"
    t.integer "post_id"
    t.datetime "created_at", null: false
